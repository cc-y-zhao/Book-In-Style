    ...
    <>
      ...
      <div>
        <div className='services-homepage-top'>
          ...
          <NavLink key={1} exact to={`/businesses/categories/Women's-Haircuts`}>
          ...
          <NavLink key={2} exact to={`/businesses/categories/Lashes`}>
            <div className='service-pic-label'>
          ...
          <NavLink key={3} exact to={`/businesses/categories/Men's-Haircuts`}>
            <div className='service-pic-label'>
          ...
          <NavLink key={4} exact to={`/businesses/categories/Spas`}>
            <div className='service-pic-label'>
          ...
          <NavLink key={5} exact to={`/businesses/categories/Nail-Salons`}>
            <div className='service-pic-label'>
        ...
        <div className='services-homepage-top'>
          ...
          <NavLink key={6} exact to={`/businesses/categories/Kid's-Haircuts`}>
            <div className='service-pic-label'>
          ...
          <NavLink key={7} exact to={`/businesses/categories/Hair-Styling`}>
            <div className='service-pic-label'>
          ...
          <NavLink key={8} exact to={`/businesses/categories/Makeup`}>
            <div className='service-pic-label'>
          ...
          <NavLink key={9} exact to={`/businesses/categories/Hair-Coloring`}>
            <div className='service-pic-label'>
          ...
          <NavLink key={10} exact to={`/businesses/categories/Perms`}>
            <div className='service-pic-label'>
